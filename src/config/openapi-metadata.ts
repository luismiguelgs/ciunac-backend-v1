...
const API_TAGS = [
  ...
  },
  {
    ...
    description:
      'Solicitudes, constancias, certificados, becas, pagos y tipos de solicitud.',
  },
  {
    name: 'Auxiliares',
  ...
  },
  {
    ...
    description:
      'Examenes, detalles, calificaciones, cronograma y actas de ubicacion.',
  },
  {
    name: 'Principales',
  ...
  },
  {
    ...
    description:
      'Perfil docente, documentos, encuestas, metricas, resultados y dashboard.',
  },
  {
    name: 'Q10',
...
const API_KEY_AND_JWT_OPERATIONS = new Set([
  ...
  'patch /actasexamenubicacion/{id}',
  'delete /actasexamenubicacion/{id}',
]);
...
const DEPRECATED_OPERATIONS = new Map([
  ...
  [
    'patch /actasexamenubicacion/{id}',
    'Endpoint deprecado: las actas de examen de ubicacion son inmutables.',
  ],
  [
    'delete /actasexamenubicacion/{id}',
    'Endpoint deprecado: las actas de examen de ubicacion son inmutables.',
        ...
        schema: {
          ...
          properties: {
            ...
            fileId: {
              type: 'string',
              description:
                'ID opcional para reemplazar/mover un archivo existente.',
            },
          },
        },
      },
...
const addStandardResponses = (
  ...
  if (security?.length) {
    ...
    ensureResponse(
      operation,
      '403',
      'Acceso denegado por permisos o API key invalida.',
    );
  }
};
