...
describe('PerfilDocenteService', () => {
  ...
  describe('create', () => {
    it('should create and save a new perfil docente', async () => {
      ...
      const expectedResult = {
        id: 'c5d6-e7f8-g9h0-i1j2-k3l4m5n6o7p8',
        ...createPerfilDocenteDto,
      };
      ...
      expect(mockPerfilDocenteRepository.create).toHaveBeenCalledWith(
        createPerfilDocenteDto,
      );
      expect(mockPerfilDocenteRepository.save).toHaveBeenCalledWith(
        expectedResult,
      );
  ...
  describe('findOne', () => {
    ...
    it('should throw a NotFoundException if perfil docente not found', async () => {
      ...
      await expect(
        service.findOne('c5d6-e7f8-g9h0-i1j2-k3l4m5n6o7p8'),
  ...
  describe('update', () => {
    it('should update a perfil docente', async () => {
      ...
      const result = await service.update(
        'c5d6-e7f8-g9h0-i1j2-k3l4m5n6o7p8',
        updatePerfilDocenteDto,
      );
      expect(mockPerfilDocenteRepository.preload).toHaveBeenCalledWith({
        id: 'c5d6-e7f8-g9h0-i1j2-k3l4m5n6o7p8',
        ...updatePerfilDocenteDto,
      });
      expect(mockPerfilDocenteRepository.save).toHaveBeenCalledWith(
    ...
    it('should throw a NotFoundException if perfil docente to update not found', async () => {
      ...
      await expect(
        service.update('c5d6-e7f8-g9h0-i1j2-k3l4m5n6o7p8', {}),
      ).rejects.toThrow(NotFoundException);
    });
  });

  describe('remove', () => {
    it('should hide a perfil docente', async () => {
      const perfilToRemove = {
        id: 'c5d6-e7f8-g9h0-i1j2-k3l4m5n6o7p8',
        visible: true,
      };
      mockPerfilDocenteRepository.findOne.mockResolvedValue(perfilToRemove);
      mockPerfilDocenteRepository.save.mockResolvedValue(perfilToRemove);

      const result = await service.remove('c5d6-e7f8-g9h0-i1j2-k3l4m5n6o7p8');
      expect(mockPerfilDocenteRepository.findOne).toHaveBeenCalledWith({
        where: { id: 'c5d6-e7f8-g9h0-i1j2-k3l4m5n6o7p8' },
        relations: ['docente', 'idioma'],
      });
    ...
    it('should throw a NotFoundException if perfil docente to remove not found', async () => {
      mockPerfilDocenteRepository.findOne.mockResolvedValue(null);
      await expect(
        service.remove('c5d6-e7f8-g9h0-i1j2-k3l4m5n6o7p8'),
      ).rejects.toThrow(NotFoundException);
    });
  });
});
